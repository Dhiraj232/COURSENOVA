    ...
    if (!user) {
        navButtons.innerHTML = `
            <div id="guestButtons" style="display: flex; gap: 1rem; align-items: center;">
                <a href="http://localhost:5000/auth/google" class="btn-login" style="background: white; color: #4285F4; border: 1px solid #4285F4; display: flex; align-items: center; gap: 0.5rem; text-decoration: none;">
